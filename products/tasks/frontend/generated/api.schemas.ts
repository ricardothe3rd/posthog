 ...
 * `openai` - openai
 */
export type ProviderD50EnumApi = (typeof ProviderD50EnumApi)[keyof typeof ProviderD50EnumApi]

export const ProviderD50EnumApi = {
    Anthropic: 'anthropic',
    Openai: 'openai',
} as const
...
* `codex` - codex */
    ...
    /** LLM provider backing the selected runtime adapter.

* `anthropic` - anthropic
* `openai` - openai */
    provider?: ProviderD50EnumApi
...
* `cloud` - Cloud */
    ...
    readonly provider: ProviderD50EnumApi | NullEnumApi | null
    /**
