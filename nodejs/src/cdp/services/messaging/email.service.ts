...
export class EmailService {
    ...
    private async sendEmailWithSES(
        ...
        const isTransactionalEmail =
            result.invocation.hogFunction?.metadata?.message_category_type === 'transactional' ||
            result.invocation.queueMetadata?.messageCategoryType === 'transactional'
